using Knara.MultiTenant.IsolationEnforcer.Analyzers;
...
namespace Knara.MultiTenant.IsolationEnforcer.EntityFramework
{
    ...
    {
        protected TenantIsolatedDbContext(DbContextOptions options, Knara.MultiTenant.IsolationEnforcer.Core.ITenantContextAccessor tenantAccessor, ILogger logger) : base(options) { }
    }
    
    public abstract class TenantIsolatedRepository<TEntity, TContext> where TEntity : class where TContext : DbContext
    {
        protected TContext Context { get; }
        protected TenantIsolatedRepository(TContext context, Knara.MultiTenant.IsolationEnforcer.Core.ITenantContextAccessor tenantAccessor, ILogger logger) 
        {
            Context = context;
        }
...
namespace TestApp.Entities
{
    ...
    public class Project : Knara.MultiTenant.IsolationEnforcer.Core.ITenantIsolated
    {
        public Guid Id { get; set; }
...
namespace TestApp.Data
{
    ...
    public class SafeDbContext : Knara.MultiTenant.IsolationEnforcer.EntityFramework.TenantIsolatedDbContext
    {
        public SafeDbContext(DbContextOptions<SafeDbContext> options,
                            Knara.MultiTenant.IsolationEnforcer.Core.ITenantContextAccessor tenantAccessor,
...
namespace TestApp.Repositories
{
    ...
    public sealed class SafeRepository : Knara.MultiTenant.IsolationEnforcer.EntityFramework.TenantIsolatedRepository<TestApp.Entities.Project, TestApp.Data.UnsafeDbContext>
    {
...
{
    [Knara.MultiTenant.IsolationEnforcer.Core.AllowCrossTenantAccess(""System admin needs to view all companies"", ""SystemAdmin"")]
    public sealed class GetAllCompaniesUnsafe
    {
        public void AddEndpoint(IEndpointRouteBuilder app)
        {
            app.MapGet(""/api/admin/companies"",
                async (Knara.MultiTenant.IsolationEnforcer.AspnetCore.ICrossTenantOperationManager crossTenantManager,
