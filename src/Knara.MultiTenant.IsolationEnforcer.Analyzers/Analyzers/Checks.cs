...
public static class TenantChecks
{
	...
	{
		return symbol.ContainingNamespace.ToDisplayString().StartsWith("Knara.MultiTenant.IsolationEnforcer") ||
			   symbol.ContainingNamespace.ToDisplayString().StartsWith("Knara.MultiTenant.IsolationEnforcer");
	}
